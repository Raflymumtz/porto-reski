...
module.exports = {
  ...
  tools: {
    ...
    fields: [
      ...
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'logo', label: 'Logo image', type: 'image', hint: 'Optional — falls back to a monogram badge if left empty.' },
    ],
  },
  topVideos: {
    label: 'Top Videos',
    singular: 'Top Video',
    icon: '📈',
    listColumns: ['caption', 'likes', 'comments', 'views'],
    fields: [
      {
        name: 'projectId',
        label: 'Project',
        ...
        required: true,
        hint: 'Which project this video showcase belongs to (e.g. a Social Media Management project).',
      },
      {
        name: 'youtubeUrl',
        label: 'YouTube link',
  ...
  igPosts: {
    ...
    icon: '📷',
    listColumns: ['account', 'likes', 'comments', 'shares', 'saves'],
    fields: [
      {
        name: 'projectId',
        label: 'Project',
        ...
        optionsFrom: 'projects',
        required: true,
        hint: 'Which project this post belongs to (e.g. a Content Design project).',
      },
      { name: 'image', label: 'Post image', type: 'image' },
      { name: 'instagramUrl', label: 'Instagram link', type: 'text', required: true },
      { name: 'account', label: 'Instagram account (without @)', type: 'text' },
      { name: 'likes', label: 'Likes', type: 'number' },
      { name: 'comments', label: 'Comments', type: 'number' },
